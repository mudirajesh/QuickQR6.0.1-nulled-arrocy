        ...
        if (isset($restaurant['user_id'])) {
            ...
            foreach ($orders as $order) {
                ...
                foreach ($order_items as $order_item) {
                    ...
                    $print_tpl_menu .= '<tr><td>'.$order_item['name'].' &times; '.$order_item['quantity'].'</td><td>'.price_format($order_item['price'] * $order_item['quantity'],$currency).'</td></tr>';
