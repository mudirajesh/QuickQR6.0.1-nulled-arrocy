                                                    ...
                                                    <div class="tab-pane" id="whatsapp_ordering">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#whatsapp_ordering">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input name="quickorder_purchase_key" type="text" class="form-control" value="(arrocy)-8a79-523d-c61f-cd01f967b2e4" readonly>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="quickad_purchase_code">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_purchase_code">
                                                            ...
                                                            <div class="form-group">
                                                                <label>Purchase Code:</label>
                                                                <div>
                                                                    <input name="purchase_key" type="text" class="form-control" value="(arrocy)-8a79-523d-c61f-cd01f967b2e4" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input name="buyer_email" type="text" class="form-control" value="arrocy@gmail.com" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="panel-footer">
